...
# ATTENTION
Коммерческую версию проекта для СБЕР к сожалению выложить в общий репозиторий не могу, но вы можете обратиться ко мне для просмотра данного проекта.
Я выложил саму связку Benuba + FaceTracker + React, чтобы каждый мог задействовать это в своих проектах.
